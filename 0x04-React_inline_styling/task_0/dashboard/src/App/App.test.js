...
describe("App tests", () => {
  ...
  it('should render BodySectionWithMarginBottom component with title "Log in to continue" when not logged in', () => {
    const component = shallow(<App isLoggedIn={false} />);

    expect(component.find("BodySectionWithMarginBottom").prop("title")).toBe(
      "Log in to continue"
    );
  });
